...
var graphviz = {
    layout: function (dotSource, outputFormat, layoutEngine, ext) {
        ...
        return loadWasm(graphvizlib$1).then(function (wasm) {
...
function graphvizSync() {
    return loadWasm(graphvizlib$1).then(function (wasm) { return new GraphvizSync(wasm); });
}

export { graphviz, graphvizSync, wasmFolder };
